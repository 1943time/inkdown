...
export type ListNode = {type: 'list', children: ListItemNode[], order?: boolean, start?: number, task?: boolean}
...
export type MediaNode = {type: 'media', url?: string, alt: string, downloadUrl?: string, height?: number, docId?: string, hash?: string}
