  ...
  return (
    <>
      <div className={'text-center text-[13px] mt-3 text-gray-500'}>
        ...
        It can share your markdown documents or folders with one click. <a className={'link mx-0.5'} href={'https://pb.bluemd.me/official/book/docs/share'} target={'_blank'}>guide</a>for details.
      </div>
      <Button
