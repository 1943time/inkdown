...
export type CodeNode = {type: 'code', children: {text: ''}[], language?: string, katex?: boolean, render?: boolean, frontmatter?: boolean, h?: number, code: string}
...
export type TableCellNode = {type: 'table-cell', title?: boolean, align?: Align, children: BaseElement['children'], width?: number}
...
export type MediaNode = {type: 'media', url?: string, alt: string, downloadUrl?: string, id?: string, height?: number, mediaType?: string, align?: 'left' | 'right', size?: number}
