  ...
  (
    ...
    return {
      __root: css`
        ...
        --lobe-markdown-border-color: ${isDarkMode ? token.colorBorderSecondary : rgba(token.colorBorderSecondary, 0.5)};
      ...
      hr: css`
        hr {
          ...
          border-color: ${isDarkMode ? 'rgba(255, 255, 255, 0.2)' : '#9ca3af'};
          border-style: dashed;
          border-width: 1px;
